import{f,G as H,S as q,P as Q,g as I,W as $,T as J,h as L,b as M,d as _,M as C,A as z,i as K,j as X,k as Z,C as ee}from"./BD8dNJ6u.js";import{e as A,r as d,l as ie,n as te,m as ae,c as oe,o as O,i as w,g as ne}from"./t8Z0vWH_.js";const se=`#define GLSLIFY 1
uniform float time;
...
}`;function ce(r){return(r/=.5)<1?.5*Math.pow(r,2):-.5*((r-=2)*r-2)}const N=3,ge=A({__name:"Burn",setup(r){const y=d(null),x=d(0),t=d(new f),R=d(0),v=d(1);let U,o,m,b,n,k,F,l,h,T,u,P,j=new ee,c=d([]),p=new H;const B=async()=>{if(!y.value)return;U=new q,o=new Q,o.aspect=3/2,o.far=1e3,o.setFocalLength(50),o.position.set(0,0,50),o.lookAt(new I),m=new $({antialias:!0,alpha:!0,canvas:y.value}),m.setSize(window.innerWidth,window.innerHeight),m.setPixelRatio(window.devicePixelRatio),m.setClearColor(921102,1);const e=new J;await Promise.all([e.loadAsync(w("/images/experiments/burn/noise.png")),e.loadAsync(w("/images/experiments/burn/image01.jpg")),e.loadAsync(w("/images/experiments/burn/image02.jpg")),e.loadAsync(w("/images/experiments/burn/image03.jpg"))]).then(i=>{const a=i[0];c.value=i.slice(1),a.wrapS=L,a.wrapT=L,k=E(a),P=Y(a),h=W(a),h.renderOrder=10,P.position.z=5,p.add(k),p.add(h),p.add(P),U.add(p)})},E=e=>{b=new M(1,1,64,64),n=new _({uniforms:{time:{value:0},easeTransition:{value:0},noiseTex:{value:e},imgPrevTex:{value:c.value[R.value]},imgNextTex:{value:c.value[v.value]},imgRatio:{value:new f}},vertexShader:se,fragmentShader:re});const i=new C(b,n);return i.name="plane",i},W=e=>{F=new M(1,1,128,128),l=new _({uniforms:{time:{value:0},easeTransition:{value:0},noiseTex:{value:e},imgRatio:{value:new f}},vertexShader:ve,fragmentShader:me,transparent:!0,blending:z});const i=new C(F,l);return i.name="fire",i},Y=e=>{const i=new M(1,1,32,32);T=new K,T.setAttribute("position",i.attributes.position),T.setAttribute("uv",i.attributes.uv),u=new _({uniforms:{time:{value:0},easeTransition:{value:0},noiseTex:{value:e},imgRatio:{value:new f},pixelRatio:{value:window.devicePixelRatio}},vertexShader:le,fragmentShader:ue,transparent:!0,blending:z});const a=new X(T,u);return a.name="points",a},V=()=>{R.value=v.value,v.value=v.value+1>=c.value.length?0:v.value+1,n.uniforms.imgPrevTex.value=c.value[R.value],n.uniforms.imgNextTex.value=c.value[v.value]},D=()=>{t.value.set(document.body.clientWidth,window.innerHeight),o.aspect=t.value.x/t.value.y,o.updateProjectionMatrix(),m.setSize(t.value.x,t.value.y);const e=Z.degToRad(o.fov),i=Math.abs((o.position.z-p.position.z)*Math.tan(e/2)*2),a=i*o.aspect,G=new f,s=new I;G.set(t.value.x>t.value.y?t.value.y*.2:t.value.x*.1,t.value.x>t.value.y?t.value.y*.2:t.value.y*.333),s.set(a*(t.value.x-G.x)/t.value.x,i*(t.value.y-G.y)/t.value.y,1);const g=new f(Math.min(1,s.x/s.y),Math.min(1,s.y/s.x));n.uniforms.imgRatio.value.set(g.x,g.y),l.uniforms.imgRatio.value.set(g.x,g.y),u.uniforms.imgRatio.value.set(g.x,g.y),k.scale.copy(s),h.scale.copy(s),P.scale.copy(s)},S=()=>{requestAnimationFrame(S);let e=j.getDelta();x.value+=e;const i=x.value/N>=1,a=i?0:ce(Math.min(x.value/N,1));i?(x.value=0,V(),n.uniforms.easeTransition.value=0,u.uniforms.easeTransition.value=0,l.uniforms.easeTransition.value=0):(n.uniforms.easeTransition.value=a,u.uniforms.easeTransition.value=a,l.uniforms.easeTransition.value=a),n.uniforms.time.value+=e,u.uniforms.time.value+=e,l.uniforms.time.value+=e,m.render(U,o)};return ie(()=>{te(async()=>{await B(),D(),S(),window.addEventListener("resize",D)})}),ae(()=>{window.removeEventListener("resize",D)}),(e,i)=>(O(),oe("canvas",{ref_key:"burnRef",ref:y},null,512))}}),xe=A({__name:"Burn",setup(r){return(y,x)=>(O(),ne(ge))}});export{xe as default};
